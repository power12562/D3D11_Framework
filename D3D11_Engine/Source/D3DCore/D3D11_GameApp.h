...
{
	LeftButton = MK_LBUTTON,  // 왼쪽 버튼
	RightButton = MK_RBUTTON,  // 오른쪽 버튼
	MiddleButton = MK_MBUTTON, // 중간(휠) 버튼
	XButton1 = MK_XBUTTON1, // X 버튼 1
	XButton2 = MK_XBUTTON2, // X 버튼 2

	// 버튼 조합들 (단일 버튼 조합)
	LeftButton_RightButton = LeftButton | RightButton,
	LeftButton_MiddleButton = LeftButton | MiddleButton,
	LeftButton_XButton1 = LeftButton | XButton1,
	LeftButton_XButton2 = LeftButton | XButton2,

	RightButton_MiddleButton = RightButton | MiddleButton,
	RightButton_XButton1 = RightButton | XButton1,
	RightButton_XButton2 = RightButton | XButton2,

	MiddleButton_XButton1 = MiddleButton | XButton1,
	MiddleButton_XButton2 = MiddleButton | XButton2,

	XButton1_XButton2 = XButton1 | XButton2,

	// 버튼 모두 조합
	LeftButton_RightButton_MiddleButton = LeftButton | RightButton | MiddleButton,
	LeftButton_RightButton_XButton1 = LeftButton | RightButton | XButton1,
	LeftButton_RightButton_XButton2 = LeftButton | RightButton | XButton2,

	LeftButton_MiddleButton_XButton1 = LeftButton | MiddleButton | XButton1,
	LeftButton_MiddleButton_XButton2 = LeftButton | MiddleButton | XButton2,

	LeftButton_XButton1_XButton2 = LeftButton | XButton1 | XButton2,

	RightButton_MiddleButton_XButton1 = RightButton | MiddleButton | XButton1,
	RightButton_MiddleButton_XButton2 = RightButton | MiddleButton | XButton2,

	RightButton_XButton1_XButton2 = RightButton | XButton1 | XButton2,

	MiddleButton_XButton1_XButton2 = MiddleButton | XButton1 | XButton2,

	// 모든 버튼 조합
	LeftButton_RightButton_MiddleButton_XButton1 = LeftButton | RightButton | MiddleButton | XButton1,
	LeftButton_RightButton_MiddleButton_XButton2 = LeftButton | RightButton | MiddleButton | XButton2,
	LeftButton_RightButton_XButton1_XButton2 = LeftButton | RightButton | XButton1 | XButton2,
	LeftButton_MiddleButton_XButton1_XButton2 = LeftButton | MiddleButton | XButton1 | XButton2,
	RightButton_MiddleButton_XButton1_XButton2 = RightButton | MiddleButton | XButton1 | XButton2,

	AllButtons = LeftButton | RightButton | MiddleButton | XButton1 | XButton2  // 모든 버튼 눌림
};

//key table use MS Virtual-Key Code : https://learn.microsoft.com/ko-kr/windows/win32/inputdev/virtual-key-codes
enum class KeyboardVK : unsigned short
{
...
protected:
	...
	virtual void PreProcessKeyboradMessage(UINT message, KeyboardVK keyCode) {}
